        ...
        {activePackageIds === null ? (
          ...
          <>
            <div style={{ marginBottom: 40, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
                <h2 className="font-display" style={{ fontSize: 28, fontWeight: 400, color: 'var(--ink)', letterSpacing: '-0.02em' }}>
              ...
              {visiblePackages.map((pkg) => (
                <div key={pkg.id} className="pkg-card" style={{
                  ...
                  <div style={{ padding: '20px 22px' }}>
                    <div style={{ fontSize: 12, color: 'var(--teal)', letterSpacing: '0.04em', fontWeight: 600, marginBottom: 8 }}>
                      {pkg.nights} NIGHTS · {pkg.days} DAYS
                    </div>
                    <h3 className="font-display" style={{ fontSize: 17, fontWeight: 500, color: 'var(--ink)', marginBottom: 16, lineHeight: 1.2, letterSpacing: '-0.01em' }}>
                      {pkg.name}
                    </h3>
