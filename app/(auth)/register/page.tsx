      ...
      <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ maxWidth: 520, width: '100%', textAlign: 'center', padding: '64px 48px', background: 'white', border: '1px solid var(--rule)' }}>
          ...
          <div style={{ padding: '20px 24px', background: 'var(--teal-lt)', border: '1px solid var(--rule)', marginBottom: 32, textAlign: 'left' }}>
            <div style={{ fontSize: 12, color: 'var(--teal)', fontWeight: 700, letterSpacing: '0.04em', marginBottom: 10 }}>WHAT HAPPENS NEXT</div>
      ...
      <div style={{ background: 'var(--bg)', overflowY: 'auto', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '48px 56px' }}>
        <div style={{ width: '100%', maxWidth: 480 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            {/* Section: Agency Info */}
            <div style={{ fontSize: 12, color: 'var(--teal)', letterSpacing: '0.04em', fontWeight: 700, marginBottom: 16 }}>AGENCY INFORMATION</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 32 }}>
              <div>
                <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>FULL NAME *</label>
                <input className="input-field" required placeholder="Your full name" value={form.full_name} onChange={set('full_name')} />
              </div>
              <div>
                <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>AGENCY / COMPANY NAME *</label>
                <input className="input-field" required placeholder="Your travel agency name" value={form.agency_name} onChange={set('agency_name')} />
              </div>
              <div>
                <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>AGENCY ADDRESS *</label>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>CITY *</label>
                  <input className="input-field" required placeholder="Mumbai" value={form.city} onChange={set('city')} />
                </div>
                <div>
                  <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>MOBILE *</label>
                  <input className="input-field" required placeholder="+91 98765 43210" value={form.mobile} onChange={set('mobile')} />
                </div>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>WHATSAPP NUMBER *</label>
                  <input className="input-field" required placeholder="+91 98765 43210" value={form.whatsapp_number} onChange={set('whatsapp_number')} />
                </div>
                <div>
                  <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>AGENCY WEBSITE</label>
              ...
              <div>
                <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>HOW DID YOU HEAR ABOUT US? *</label>
              ...
              {/* Agency Logo Upload */}
              <div>
                <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>
            ...
            <div style={{ fontSize: 12, color: 'var(--teal)', letterSpacing: '0.04em', fontWeight: 700, marginBottom: 16 }}>LOGIN DETAILS</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 32 }}>
              <div>
                <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>BUSINESS EMAIL *</label>
              ...
              <div>
                <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink-mid)', letterSpacing: '0.04em', display: 'block', marginBottom: 8 }}>CONFIRM PASSWORD *</label>
