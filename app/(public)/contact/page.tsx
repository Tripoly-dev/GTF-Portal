...
export default function ContactPage() {
  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '80vh' }}>
      ...
      {/* Header */}
      <div style={{ background: 'var(--paper)', borderBottom: '1px solid var(--rule)', padding: 'clamp(38px, 9vw, 64px) clamp(18px, 5vw, 56px)' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{ fontSize: 13, color: 'var(--teal)', fontWeight: 600, marginBottom: 16 }}>Get in touch</div>
          <h1 className="font-display" style={{ fontSize: 'clamp(36px, 5vw, 60px)', fontWeight: 400, color: 'var(--ink)', letterSpacing: '-0.03em', lineHeight: 1 }}>
            Let's talk about<br /><span style={{ fontWeight: 400, fontStyle: 'italic', color: 'var(--teal)' }}>your travel business.</span>
          </h1>
        </div>
      </div>

      <div style={{ maxWidth: 1280, margin: '0 auto', padding: 'clamp(43px, 9vw, 72px) clamp(18px, 5vw, 56px)' }}>
        <div className="rg-stack" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 80 }}>

          {/* Contact info */}
          <div>
            <div style={{ marginBottom: 48 }}>
              <div style={{ fontSize: 13, color: 'var(--teal)', fontWeight: 600, marginBottom: 20 }}>Office</div>
              <p style={{ fontSize: 15, color: 'var(--ink-mid)', lineHeight: 1.9, fontWeight: 400 }}>
            ...
            <div style={{ marginBottom: 48 }}>
              <div style={{ fontSize: 13, color: 'var(--teal)', fontWeight: 600, marginBottom: 20 }}>Phone</div>
            ...
            <div style={{ marginBottom: 48 }}>
              <div style={{ fontSize: 13, color: 'var(--teal)', fontWeight: 600, marginBottom: 20 }}>Email</div>
            ...
            {/* Quick links */}
            <div style={{ padding: '28px clamp(18px, 5vw, 32px)', background: 'var(--teal-lt)', border: '1px solid var(--rule)' }}>
          ...
          <div>
            {sent ? (
              <div style={{ textAlign: 'center', padding: 'clamp(48px, 9vw, 80px) clamp(18px, 5vw, 40px)', background: 'white', border: '1px solid var(--rule)' }}>
                <div style={{ fontSize: 48, marginBottom: 20 }}>✓</div>
                <h3 className="font-display" style={{ fontSize: 24, fontWeight: 500, color: 'var(--teal)', marginBottom: 12 }}>Message sent!</h3>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                <div className="rg-stack-sm" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                  ...
                  <div>
                    <label style={{ fontSize: 13, fontWeight: 600, color: 'var(--ink-mid)', display: 'block', marginBottom: 8 }}>Agency name *</label>
                ...
                <div className="rg-stack-sm" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                  <div>
                    <label style={{ fontSize: 13, fontWeight: 600, color: 'var(--ink-mid)', display: 'block', marginBottom: 8 }}>Email *</label>
                ...
                <div>
                  <label style={{ fontSize: 13, fontWeight: 600, color: 'var(--ink-mid)', display: 'block', marginBottom: 8 }}>Message *</label>
