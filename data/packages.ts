...
export const PACKAGES: Package[] = [
  ...
  {
    id: 'af-01',
    name: 'Roar & Explore — Tanzania Untamed',
    nights: 4, days: 5,
    region: 'africa',
  ...
  {
    id: 'af-03',
    name: 'Tanzania Untamed with Zanzibar',
    nights: 7, days: 8,
    region: 'africa',
    workdriveUrl: 'https://workdrive.zohoexternal.in/file/77r61e6fabaf10d354f04831ea7df84367873',
  ...
  {
    id: 'af-04',
    name: "Kenya's Ultimate Safari Circuit",
    nights: 7, days: 8,
    region: 'africa',
  ...
  {
    id: 'af-09',
    name: 'Into the Heart of the Wild',
    nights: 6, days: 7,
    region: 'africa',
...
export const REGIONS = {
  ...
  africa: {
    ...
    desc: 'Kenya, Tanzania and beyond — witness the Great Migration, track the Big Five and experience the raw beauty of East Africa. GTF\'s safari circuit is built for groups seeking authentic wildlife immersion.',
  ...
  oceania: {
    ...
    desc: 'Sydney, Melbourne, the Great Barrier Reef and the Red Centre — Australia delivers landscapes unlike anywhere on earth. New series launching soon.',
  ...
  asia: {
    ...
    desc: 'Japan, South Korea, Thailand, Vietnam, Cambodia and beyond — Asia offers GTF\'s most diverse product range. Packages coming soon.',
  ...
  americas: {
    ...
    desc: 'USA, Canada, Brazil, Peru and the wider Americas — GTF is building a brand new series. Watch this space.',
...
export const FAQS = [
  {
    q: 'Why should I choose GTF Holidays for my travel business?',
    a: 'At GTF Holidays LLP, we specialize in professionally curated B2B travel solutions designed exclusively for travel partners. With extensive experience in Series Departures, White Label Solutions, ADHOC Groups, and Bespoke Customised Holidays, we provide complete backend support including operations, visa assistance, hotel contracting, meals, tour managers, and on-ground coordination — allowing our partners to focus on sales and customer relationships.',
    cat: 'General',
  },
  {
    q: 'What are Series Departures?',
    a: 'Series Departures are pre-planned fixed departure group tours with confirmed itineraries, hotels, sightseeing, and departures on specified dates. These tours are designed to offer cost-effective pricing, seamless operations, and professionally managed travel experiences for groups.',
    cat: 'General',
  },
  {
    q: 'What destinations do you operate?',
  ...
  {
    q: 'What is a White Label Solution?',
    a: 'Our White Label Solutions allow travel companies to sell and operate tours under their own brand name while GTF Holidays manages the backend operations, logistics, contracting, and execution discreetly.',
    cat: 'General',
  },
  {
    q: 'What are ADHOC Groups?',
    a: 'ADHOC Groups are customized group departures created specifically for closed groups such as families, corporates, institutions, communities, incentive groups, student groups, social groups, or special interest travellers.',
    cat: 'General',
  },
  {
    q: 'Do you provide fully customized holidays?',
    a: 'Yes. We design Bespoke Customised Holidays based on the traveller\'s preferences, budget, travel style, interests, meal requirements, hotel preferences, sightseeing priorities, and operational feasibility.',
    cat: 'General',
  },
  {
    q: 'What is the "Tour Family" concept?',
    a: 'The "Tour Family" concept is a unique approach where travellers from various travel partners come together and travel as one professionally managed tour family. This allows travel partners to confidently promote and sell departures under a collaborative B2B ecosystem while GTF Holidays manages the backend operations seamlessly.',
    cat: 'General',
  },
  {
    q: 'What is the "Agent Voice" concept?',
    a: 'The "Agent Voice" concept is a unique support initiative where our experienced team members directly communicate with your clients under your company\'s banner — providing accurate tour information, destination guidance, and travel assistance. GTF operates purely as a backend B2B partner, ensuring the travel partner always remains the primary face for the client.',
    cat: 'General',
  },
  {
    q: 'Are meals included on tours?',
    a: 'Most group departures include meals as mentioned in the itinerary. Depending on the destination and tour design, meals may include Indian, Jain, Vegetarian, Non-Vegetarian, Continental, local cuisine experiences, buffet meals, packed meals, or fixed group menus.',
    cat: 'Travel & Tour',
  },
  {
    q: 'Do your tours include Tour Managers?',
    a: 'Yes. Our Series Departures and many group tours are accompanied by experienced professional Tour Managers or Tour Representatives for seamless coordination and guest assistance throughout the journey.',
    cat: 'Travel & Tour',
  },
  {
    q: 'What category of hotels do you provide?',
    a: 'We generally provide carefully selected hotels or equivalent accommodations, ensuring comfort, cleanliness, location advantage, and operational convenience for travellers.',
    cat: 'Hotels & Accommodation',
  },
  {
    q: 'How many passengers are usually in a group?',
    a: 'Group sizes generally range between 25 to 45 guests, allowing a comfortable balance between personalized attention and group travel experience.',
    cat: 'Travel & Tour',
  },
  {
    q: 'Are your tours suitable for senior citizens and families?',
    a: 'Yes. Our tours are designed to cater to families, couples, senior citizens, honeymooners, youngsters, and first-time international travellers.',
    cat: 'Travel & Tour',
  },
  {
    q: 'Do you work only with travel partners across India?',
    a: 'No. While we have a strong network across India, we also collaborate with travel companies, tour operators, and travel agencies globally. GTF Holidays LLP operates exclusively as a B2B travel operator and does not deal in B2C retail business.',
    cat: 'B2B & White Label Support',
  },
  {
    q: 'How do I register as a partner on this portal?',
    a: 'Click "Register as Agent" and fill in your agency details. Your application will be reviewed by our team within 24-48 hours. Upon approval, you\'ll receive access to view detailed itineraries, request quotes, and access partner-exclusive resources.',
    cat: 'B2B & White Label Support',
  },
]
